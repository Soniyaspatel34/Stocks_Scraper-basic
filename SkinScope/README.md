...
microscope (or your camera's macro lens). It's a personal photo journal and
magnifier tool — **not** a diagnostic or medical device.
...
- **100% local storage** — photos and notes are saved to the app's Documents
  folder on-device only; nothing is uploaded anywhere. A "Delete all scans"
  option is in the About tab.

## Why no AI analysis?

Deliberately left out. An app that scores or flags moles/lesions as
benign/concerning would be acting as an undisclosed, unvalidated medical
device — that's not something to ship without clinical validation and
regulatory review. SkinScope sticks to what's safe and genuinely useful on
your own: consistent, comparable photos over time, so you and your
dermatologist can see what changed.
...
SkinScope/
  ...
  ContentView.swift         Tab bar (Scan / History / About)
  Camera/
  ...
  Views/
    ...
    SettingsView.swift      Disclaimer + data management
```
